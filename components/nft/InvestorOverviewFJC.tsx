...
export default function InvestorOverviewFJC() {
    ...
    return (
        <div className="rounded-md border border-white/10 bg-white/5">
            ...
            {open && (
                <div className="px-4 pb-4 pt-2 text-2xs leading-relaxed space-y-5 max-h-[480px] overflow-auto">
                    <section>
                        <h3 className="text-xs font-medium text-teal-300 mb-2">ASX FJC NFT – Investor Overview</h3>
...
function Section({ title, bullets }: { title: string; bullets: string[] }) {
    return (
        <section className="space-y-2">
            <h4 className="font-medium text-white/80 text-2xs">{title}</h4>
