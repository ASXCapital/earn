...
export function AnnouncementBar() {
    ...
    return (
        <div className={clsx(
            ...
            <div className="px-4 md:px-6 lg:px-8 py-2 text-[11px] leading-relaxed flex items-start md:items-center gap-4 text-amber-100">
                ...
                <button
                    ...
                    className="shrink-0 rounded px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider bg-amber-400/20 hover:bg-amber-400/30 text-amber-100 border border-amber-300/30 shadow-sm hover:text-white transition-colors"
                >
                    Close
                </button>
            </div>
