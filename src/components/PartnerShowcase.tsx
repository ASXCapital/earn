...
const PartnerShowcase = () => {
  const partners = [
    ...
    { url: "https://www.prismres.com/", logo: "/logos/partners/PrismRE.png" },
    { url: "https://safe.global/", logo: "/logos/partners/gnosis2.svg" },
    {
    ...
    { url: "https://coredao.org/", logo: "/logos/partners/core.svg" },
    {
    ...
    { url: "https://www.plena.finance/", logo: "/logos/partners/plena.svg" },
    {
      url: "https://ave.ai/token/0xebd3619642d78f0c98c84f6fa9a678653fb5a99b-bsc?from=Default",
      logo: "/logos/partners/ave.png",
    },
    { url: "https://moralis.io/", logo: "/logos/partners/moralis.png" },
  ];
      ...
      {doubledPartners.map((partner, index) => (
        <div key={index} className={styles.logoContainer}>
          <a href={partner.url} target="_blank" rel="noopener noreferrer">
            <img
              src={partner.logo}
              alt={`Partner ${(index % partners.length) + 2}`}
