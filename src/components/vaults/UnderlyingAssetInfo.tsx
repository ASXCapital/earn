...
const UnderlyingAssetInfo: React.FC<UnderlyingAssetInfoProps> = ({ name, address }) => {
  ...
  return (
    <Row className="align-items-center">
      ...
      <Col xs="auto">
        <OverlayTrigger
          placement="top"
          overlay={<Tooltip id="button-tooltip">{buttonText === 'Copy' ? 'Copy address' : 'Address copied!'}</Tooltip>}
        >
          <Button onClick={copyToClipboard} size="sm" className={styles.copyButton}>
            {buttonText}
          </Button>
        </OverlayTrigger>
      </Col>
