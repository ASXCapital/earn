...
const rpcUrls = [
  { url: 'https://bsc.rpc.blxrbdn.com', name: 'Bloxroute', link: 'https://docs.bloxroute.com/introduction/protect-rpcs' },
  { url: 'https://bnb-bscnews.rpc.blxrbdn.com/', name: 'Bloxroute x BSCN', link: 'https://docs.bloxroute.com/introduction/protect-rpcs' },
  { url: 'https://bsc.meowrpc.com', name: 'Meow RPC', link: 'https://meowrpc.com/' },
  { url: 'https://bsc.blockpi.network/v1/rpc/public', name: 'Blockpi', link: 'https://blockpi.io/' },
  { url: 'https://practical-methodical-gadget.bsc.quiknode.pro/', name: 'ASX RPC (via Merkle - rate limited)', link: 'https://merkle.network/' }
];
