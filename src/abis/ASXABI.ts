export const ASXABI = [
    ...
    inputs: [
      {
        indexed: true,
        internalType: "uint256",
        name: "newRewardTokenFee",
        type: "uint256",
      },
    ],
    name: "RewardTokenFeeUpdated",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "bool", name: "check", type: "bool" },
    ],
    name: "UpdateCheckWhitelist",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    outputs: [{ internalType: "bool", name: "check", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "address", name: "babtAddr", type: "address" }],
    name: "setBabt",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "tokenStorage",
    outputs: [
      { internalType: "contract ASXTokenStorage", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
